Pod::Spec.new do |s|
  ...
  s.name         = 'EmpowerMobileAds-Beta'
  s.version      = '5.9.0-beta1.1'
  s.summary      = 'Empower Mobile Ads Dev'
  s.description  = <<-DESC
  ...
  s.platform     = :ios, '12.0'
  s.source       = { :http => 'https://cdn.empower.net/sdk/mobile/ios/EmpowerMobileAds-5.9.0-beta1.1.zip' }
