Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '12.0'
  s.source       = { :http => 'https://cdn.empower.net/sdk/mobile/ios/EmpowerMobileAds-5.8.34.zip'} 
  s.vendored_frameworks = 'Frameworks/EmpowerMobileAds.xcframework', 'Frameworks/EmpowerMobileAdsGAMEventHandlers.xcframework'
