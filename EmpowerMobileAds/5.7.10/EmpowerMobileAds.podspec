Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '9.0'
  s.source       = { :http => 'https://cdn.empower.net/sdk/mobile/ios/EmpowerMobileAds-5.7.10.zip' }
  ...
  s.vendored_frameworks = 'EmpowerMobileAds.xcframework', 'Frameworks/GoogleMobileAds.framework'
