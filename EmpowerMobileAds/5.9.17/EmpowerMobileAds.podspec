Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '12.0'
  s.source       = { :http => 'https://cdn.empower.net/sdk/mobile/ios/EmpowerMobileAds-5.9.17.zip'}
  ...
  s.vendored_frameworks = ["EmpowerMobileAds.framework", "Frameworks/GoogleMobileAds.framework","Frameworks/GoogleInteractiveMediaAds.xcframework","Frameworks/UserMessagingPlatform.xcframework"]
