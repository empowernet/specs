Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '9.0'
  s.source       = { :http => 'https://cdn.empower.net/sdk/mobile/ios/EmpowerMobileAds-5.4.6.zip' }
  ...
  s.vendored_frameworks = 'EmpowerMobileAds.framework', 'Frameworks/GoogleMobileAds.framework', 'Frameworks/GoogleInteractiveMedisAds.framework'
