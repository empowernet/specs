Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '9.0'
  s.source       = { :http => 'https://cdn.empower.net/sdk/mobile/ios/EmpowerAppLovinAdapter-1.0.6.zip' }
  
  s.libraries = 'z'
  s.frameworks = 'JavaScriptCore'
  s.vendored_frameworks = 'EmpowerAppLovinAdapter.xcframework', 'Frameworks/AppLovinSDK.xcframework', 'Frameworks/GoogleMobileAds.xcframework', 'Frameworks/UserMessagingPlatform.xcframework'
